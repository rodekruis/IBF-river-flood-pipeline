...
flood_data.upsert_data_unit(
    RiverDischargeDataUnit(pcode=pcode,
                           lead_time=1,
                           river_discharge_ensemble=[10, 20, 20, 10, 20, 20]))
...
trigger_thresholds_data.upsert_data_unit(
    TriggerThresholdDataUnit(adm_level=1,
                             pcode=pcode,
                             lead_time=1,
                             trigger_thresholds=[{'return_period': 2, 'threshold': 5.0},
